...
export default {
    ...
    methods: {
        ...
        create(){
            this.$router.push(`/doctors/create_specialization`)
        },

        move(id) {
            this.$router.push(`/doctors/${id}/edit_specialization`)
        },
        ...
        confirm(id) {
            Swal.fire({
                ...
                if (result.value) {
                    const url = `${process.env.apiBaseUrl}/specialization/delete/${id}`
