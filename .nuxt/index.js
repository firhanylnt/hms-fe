...
import nuxt_plugin_plugin_1b149e16 from 'nuxt_plugin_plugin_1b149e16' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_1c54ac5b from 'nuxt_plugin_bootstrapvue_1c54ac5b' // Source: ./bootstrap-vue.js (mode: 'all')
import nuxt_plugin_axios_3252ba2c from 'nuxt_plugin_axios_3252ba2c' // Source: ./axios.js (mode: 'all')
import nuxt_plugin_pluginclient_324d6e92 from 'nuxt_plugin_pluginclient_324d6e92' // Source: ./content/plugin.client.js (mode: 'client')
import nuxt_plugin_pluginserver_cff23fcc from 'nuxt_plugin_pluginserver_cff23fcc' // Source: ./content/plugin.server.js (mode: 'server')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_1b149e16 === 'function') {
    await nuxt_plugin_plugin_1b149e16(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_1c54ac5b === 'function') {
    await nuxt_plugin_bootstrapvue_1c54ac5b(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_3252ba2c === 'function') {
    await nuxt_plugin_axios_3252ba2c(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_324d6e92 === 'function') {
    await nuxt_plugin_pluginclient_324d6e92(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_cff23fcc === 'function') {
    await nuxt_plugin_pluginserver_cff23fcc(app.context, inject)
  }
